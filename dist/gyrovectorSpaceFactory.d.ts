 ...
 */
export declare class GyrovectorSpaceFactory {
    /**
     ...
     * ```
     */
    static create<Dimension extends number>(dimension: Dimension, curvature: 0): VectorSpace<Dimension>;
    /**
     ...
     * ```
     */
    static create<Dimension extends number>(dimension: Dimension, curvature: number): GyrovectorSpace<Dimension>;
}

 ...
 */
export type VectorSpaceLike<Dimension extends number, Vector extends VectorLike<Dimension, Vector>> = {
    /**
     * Adds two vectors.
     *
...
export type VectorSpaceLikeWithoutCreate<Dimension extends number, Vector extends VectorLike<Dimension, Vector>> = Omit<VectorSpaceLike<Dimension, Vector>, 'createVector'>;
